...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request): RedirectResponse
    {
        ...
        return redirect(route('roles.index'))->with('success', 'Успешно ја додадовте улогата');
    }
    ...
    public function update(Role $role, EditRoleRequest $request): RedirectResponse
    {
        ...
        return redirect(route('roles.index'))->with('success', 'Успешно ја изменивте избраната улога');
    }
    ...
    public function destroy(Role $role): RedirectResponse
    {
        ...
        if ($role->users()->exists()) {
            return back()->with('error', 'Избраната улога е веќе доделена на корисници');
        }
        $role->delete();

        return back()->with('success', 'Успешно ја избришавте избраната улога');
    }
}
